                        ...
                        <>
                            ...
                            <div className='grid grid-cols-2 gap-3 pt-1'>
                                <Button
                                    type='button'
                                    variant='outline'
                                    onClick={() => toast.info('Google Sign-in triggered')}
                                    className='h-9 rounded-xl border-input hover:bg-muted text-xs font-medium gap-2 cursor-pointer'
                                >
                                ...
                                <Button
                                    type='button'
                                    variant='outline'
                                    onClick={() => toast.info('GitHub Sign-in triggered')}
                                    className='h-9 rounded-xl border-input hover:bg-muted text-xs font-medium gap-2 cursor-pointer'
                                >
